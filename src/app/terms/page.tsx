      ...
      <div style={{ minHeight: '100vh', background: '#f8f7f4', padding: '24px 16px' }}>
        <div style={{ maxWidth: 640, margin: '0 auto', background: 'white', borderRadius: 20, padding: '32px 24px', border: '1px solid #f0ede8' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
            ...
            <h1 style={{ fontSize: '1.5rem', fontWeight: 900, color: '#f97316' }}>SnappyyOrder Terms of Service</h1>
          </div>
          <p style={{ color: '#6b7280', fontSize: '0.82rem', marginBottom: 24 }}>Last updated: April 2026</p>
  
          {[
            { title: '1. Service', content: 'SnappyyOrder is a pre-order platform for college cafés. It allows students to place food orders in advance and pick them up at a chosen time slot.' },
            ...
            { title: '3. Payment', content: 'Payments are made at the counter via UPI or cash when you collect your order. SnappyyOrder does not process payments directly.' },
            ...
            { title: '7. Accuracy', content: 'Menu prices and availability are managed by the café. SnappyyOrder is not responsible for price changes or items going out of stock after your order is placed.' },
